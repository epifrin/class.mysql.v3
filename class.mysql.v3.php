...
class MySQLQuery3{
    ...
    */
    ...
    private function db_error($msg,$text_sql, $arr_debug){
        ...
        if (!empty($mail_admin)){
            if (!mail($mail_admin, "123456.com.ua: Ошибка MySQL", $err_msg, "Content-Type: text/plain; charset=windows-1251\r\nFrom: virtual.money@dobrobut.com\r\n" . "Reply-To: virtual.money@dobrobut.com\r\n" . "X-Mailer: PHP/" . phpversion()))
            {
                echo $err_msg;
            }
        }//*/
